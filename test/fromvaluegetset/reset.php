...
<p>
Enter Full Name:<input type="text" class="input" name="name" value="<?php echo isset($name)?$name:"";?>"/>
<span class="error"><?php echo $name_error;?></span></br></br>
Mobile:<input type="text" name="mobile"  class="input" value="<?php echo isset($mobile)?$mobile:"";?>"/>
